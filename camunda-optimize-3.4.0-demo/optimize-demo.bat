...
:: the documentation: https://docs.camunda.org/optimize/3.4/technical-guide/setup/installation/
...
echo Starting Elasticsearch 7.10.0...
...
start /b "Elasticsearch" cmd /c "%BASEDIR%elasticsearch\elasticsearch-7.10.0\bin\elasticsearch.bat" >"%ELASTICSEARCH_LOG_FILE%" 2>&1
